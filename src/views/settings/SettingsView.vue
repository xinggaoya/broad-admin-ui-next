                  ...
                  <n-grid-item>
                    <div class="color-picker-item">
                      ...
                      <div class="color-picker-wrapper">
                        ...
                        <n-input
                          :value="themeColors.primary"
                          @update:value="(val: string) => updateThemeColorFromInput('primary', val)"
                          placeholder="#18a058"
                          size="small"
                  ...
                  <n-grid-item>
                    <div class="color-picker-item">
                      ...
                      <div class="color-picker-wrapper">
                        ...
                        <n-input
                          :value="themeColors.info"
                          @update:value="(val: string) => updateThemeColorFromInput('info', val)"
                          placeholder="#2080f0"
                          size="small"
                          style="flex: 1; margin-left: 8px"
                        />
                  ...
                  <n-grid-item>
                    <div class="color-picker-item">
                      ...
                      <div class="color-picker-wrapper">
                        ...
                        <n-input
                          :value="themeColors.success"
                          @update:value="(val: string) => updateThemeColorFromInput('success', val)"
                          placeholder="#18a058"
                          size="small"
                          style="flex: 1; margin-left: 8px"
                        />
                  ...
                  <n-grid-item>
                    <div class="color-picker-item">
                      ...
                      <div class="color-picker-wrapper">
                        ...
                        <n-input
                          :value="themeColors.warning"
                          @update:value="(val: string) => updateThemeColorFromInput('warning', val)"
                          placeholder="#f0a020"
                          size="small"
                          style="flex: 1; margin-left: 8px"
                        />
                  ...
                  <n-grid-item>
                    <div class="color-picker-item">
                      ...
                      <div class="color-picker-wrapper">
                        ...
                        <n-input
                          :value="themeColors.error"
                          @update:value="(val: string) => updateThemeColorFromInput('error', val)"
                          placeholder="#d03050"
                          size="small"
                          style="flex: 1; margin-left: 8px"
                        />
          ...
          <div class="settings-section">
            <n-space vertical size="large">
              ...
              <div class="setting-item" v-if="enableKeepAlive">
                ...
                <n-input-number
                  :value="maxCachePages"
                  @update:value="(val: number | null) => (appStore.maxCachePages = val || 10)"
                  :min="5"
                  :max="50"
                  style="width: 120px"
                />
...
// 更新主题颜色 - 颜色选择器
const updateThemeColor = (key: keyof ThemeColors, event: Event) => {
